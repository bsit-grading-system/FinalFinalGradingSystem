                            ...
                            <div class="box">
                                ...
                                <form method="post">
                                    <table id="table" class="table table-bordered table-striped">
                                        ...
                                        <tbody>
                                            <?php
                                            $squery = mysqli_query($con, "SELECT s.*, y.yearlevel AS yearlevel_name FROM tblsubjects s LEFT JOIN tblyearlevel y ON s.yearlevelid = y.id");
                                            if (!$squery) {
